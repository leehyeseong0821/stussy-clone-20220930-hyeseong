...
class CollectionsService {
  ...
  loadCollections() {
    if (
      this.collectionsEntity.page == 1 ||
      this.collectionsEntity.page < Number(this.collectionsEntity.maxPage) + 1
    ) {
      ...
      if (responseData.length > 0) {
        ...
        this.collectionsEntity.maxPage =
          responseData[0].productTotalCount % 16 == 0
